...
Nav.prototype.onSearch = function (e) {
    let formInput = document.querySelector(`${this.default.container} .forms-clearfix input`);
    let cname = '';
    cname = formInput.value;
